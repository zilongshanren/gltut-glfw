...
void Scene::init()
{
    _shaderProgram = createShaderProgramWithFilenames("calcOffset.vert", "calcColor.frag");
    ...
    GLuint fragLoopDurationUniform = glGetUniformLocation(_shaderProgram, "fragLoopDuration");
	glUniform1f(fragLoopDurationUniform, 2.0f);
    printOpenGLError();
